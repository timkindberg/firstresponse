...
export default function SpecialistGridNavyPage() {
  return (
    <main className="min-h-screen bg-[#0A1628]">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#0A1628] via-[#0A1628]/95 to-[#0A1628]/50" />
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-32">
          <div className="max-w-4xl">
            ...
            >
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded bg-yellow-400/20 border-2 border-yellow-400/40 text-yellow-300 text-xs font-mono uppercase tracking-widest mb-8 backdrop-blur-sm">
              ...
              <div className="bg-white/10 backdrop-blur-md p-8 rounded-lg border-2 border-white/10 mb-12 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center px-10 py-6 text-base font-bold text-[#0A1628] bg-yellow-400 rounded hover:bg-yellow-300 transition-all shadow-2xl shadow-yellow-400/40 font-mono uppercase tracking-wider hover:scale-105"
                >
                  GET FREE ESTIMATE
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="inline-flex items-center gap-4 px-6 py-4 bg-white/10 border-2 border-white/10 rounded-lg backdrop-blur-md">
                  ...
                  <div>
                    <p className="text-xs text-gray-300 uppercase tracking-wider font-mono">Firefighter</p>
                    <p className="text-base font-bold text-white font-mono">Owned &amp; Operated</p>
                  </div>
                </div>

                <div className="inline-flex items-center gap-4 px-6 py-4 bg-white/10 border-2 border-white/10 rounded-lg backdrop-blur-md">
                  <div className="w-14 h-14 bg-yellow-400/20 rounded flex items-center justify-center flex-shrink-0">
                    <Target className="w-7 h-7 text-yellow-400" />
                  </div>
                  <div>
                    <p className="text-xs text-gray-300 uppercase tracking-wider font-mono">Storm Cleanup</p>
                ...
                <div className="inline-flex items-center gap-4 px-6 py-4 bg-white/10 border-2 border-white/10 rounded-lg backdrop-blur-md">
                  ...
                  <div>
                    <p className="text-xs text-gray-300 uppercase tracking-wider font-mono">Safety Protocols</p>
        ...
        {/* Corner Accents */}
        <div className="absolute top-24 left-8 w-16 h-16 border-t-4 border-l-4 border-yellow-400 z-20" />
        <div className="absolute bottom-24 right-8 w-16 h-16 border-b-4 border-r-4 border-yellow-400 z-20" />
